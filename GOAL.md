...
- **M7（使用里程）⏳ 开放** — 建造→使用的拐点验收槽（起草于 FEBEL-L，2026-08-27 入 GOAL）：机制已齐（M6 + B4 写回接线 + 来源 tag + H1 硬化）之后，用**真实使用**证明三个飞轮在转，而不是再用工程厚度代替转速。**协议已发行**：`skills/jspace-use/references/usage-mileage.md`（随 init/upgrade 物化进工作台，含三腿关闭条件、取证口径、证据台账模板与禁伪造红线）。
