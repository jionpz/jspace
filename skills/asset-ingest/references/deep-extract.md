...
- 统一入口：`.jspace/skills/asset-ingest/scripts/extract.py`（随技能分发，已嵌入 jspace 二进制、物化进工作台 `.jspace/skills/`）。分层路由：
...
```bash
python3 .jspace/skills/asset-ingest/scripts/extract.py <文件> --out <伴生文件>
```
