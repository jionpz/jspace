...
- `skills/` —— 官方技能源码（7 个：jspace-use / asset-ingest / memory-recall / memory-writeback / workbench-retro / weekly-report / memory-consolidate），经 `scripts/gen-assets.ts` 嵌入二进制。
